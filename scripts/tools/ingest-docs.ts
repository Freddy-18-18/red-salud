...
// TODO: Re-wire imports after embedding-service and vector-store are migrated
// Old imports pointed to apps/web/lib/supabase/services/chat/ which no longer exists.
// These services need to be recreated in a shared package or the relevant app.
const embeddingService = null as any;
