...
export function InfiniteSpecialtiesScroll() {
  ...
  return (
    <div id="next-section" className="relative overflow-hidden bg-linear-to-r from-blue-50 via-teal-50 to-blue-50 py-12">
          ...
          >
            {duplicatedSpecialties.map((specialty, index) => {
              ...
              return (
                <div
                  key={index}
                  className="flex items-center gap-3 bg-white rounded-xl px-6 py-4 shadow-sm hover:shadow-md transition-shadow whitespace-nowrap min-w-fit"
                >
