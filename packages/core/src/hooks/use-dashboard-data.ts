...
// TODO: Inject supabase client from consuming app
declare const supabase: any;
import { createMedicoSdk } from "@red-salud/sdk-medico";
import { getUserConversations, getUnreadMessagesCount } from "../services/supabase/messaging-service";
import {
    getNotifications,
    getUnreadNotificationsCount,
    getTasks,
    subscribeToNotifications,
} from "../services/supabase/dashboard-preferences-service";
