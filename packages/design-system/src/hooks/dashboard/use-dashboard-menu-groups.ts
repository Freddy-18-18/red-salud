// TODO: Import from @red-salud/core when constants and specialty engine are migrated
type MenuGroup = { id: string; label: string; items: any[] };
declare const PATIENT_MODULE_CONFIG: any;
declare function getSpecialtyExperienceConfig(specialtyName?: string, subSpecialties?: string[]): any;
declare function isOdontologySpecialty(specialtyName?: string): boolean;
