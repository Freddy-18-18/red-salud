...
// TODO: Import from @red-salud/core when specialty module system is migrated
declare function validateModule(module: ModuleDefinition, context: ModuleRuntimeContext): ModuleValidationResult;
declare function filterMountableModules(modules: ModuleDefinition[], context: ModuleRuntimeContext): ModuleDefinition[];
declare function getModulesForContext(context: ModuleRuntimeContext): ModuleDefinition[];
declare function getModulesForGroup(group: ModuleGroup, context: ModuleRuntimeContext): ModuleDefinition[];
declare function getWidgetModulesForContext(context: ModuleRuntimeContext): ModuleDefinition[];
declare function validateModuleInContext(module: ModuleDefinition, context: ModuleRuntimeContext): ModuleValidationResult;
