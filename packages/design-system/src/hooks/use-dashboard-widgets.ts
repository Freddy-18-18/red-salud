...
// TODO: Import from @red-salud/core when dashboard-preferences-service is migrated
declare function getDashboardPreferences(doctorId: string): Promise<any>;
declare function saveDashboardPreferences(doctorId: string, state: any): Promise<void>;
declare function preferencesToState(prefs: any): any;
