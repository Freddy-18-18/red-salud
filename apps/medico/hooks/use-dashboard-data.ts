...
import { createMedicoSdk, type DoctorAppointment as Appointment } from '@red-salud/sdk-medico';
...
import { getUnreadMessagesCount, getUserConversations } from "@/lib/supabase/services/messaging-service";
