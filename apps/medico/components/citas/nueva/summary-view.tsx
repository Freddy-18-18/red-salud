            ...
            <div className="flex items-center justify-between gap-4">
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-baseline gap-2">
                        {values.precio ? (
                            <p className="text-lg font-bold text-green-700 dark:text-green-400">${values.precio}</p>
                        ) : (
        ...
        <Card className="h-fit sticky top-6">
            ...
            <CardContent className="pt-6 space-y-5">
                <div className="flex items-start space-x-3 group">
                    <div className="p-2 bg-blue-50 dark:bg-gray-800/60 rounded-lg group-hover:bg-blue-100 dark:group-hover:bg-gray-700/60 transition-colors">
                ...
                <div className="flex items-start space-x-3 group">
                    <div className="p-2 bg-violet-50 dark:bg-gray-800/60 rounded-lg group-hover:bg-violet-100 dark:group-hover:bg-gray-700/60 transition-colors">
                ...
                <div className="flex items-start space-x-3 group">
                    <div className="p-2 bg-amber-50 dark:bg-gray-800/60 rounded-lg group-hover:bg-amber-100 dark:group-hover:bg-gray-700/60 transition-colors">
                ...
                <div className="flex items-start space-x-3 group">
                    <div className="p-2 bg-emerald-50 dark:bg-gray-800/60 rounded-lg group-hover:bg-emerald-100 dark:group-hover:bg-gray-700/60 transition-colors">
                ...
                {values.precio && (
                    <>
                        <div className="h-px bg-border/50" />
                        <div className="flex items-start space-x-3 group">
                            <div className="p-2 bg-green-50 dark:bg-gray-800/60 rounded-lg group-hover:bg-green-100 dark:group-hover:bg-gray-700/60 transition-colors">
