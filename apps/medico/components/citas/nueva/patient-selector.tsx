...
import { Button, Input, Card, CardContent, CardHeader, CardTitle, CardDescription, Alert, AlertDescription, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@red-salud/design-system";
                    ...
                    <div className="bg-muted/50 p-4 rounded-lg border border-border relative group">
                        ...
                        <div className="flex items-start justify-between pr-8">
                            ...
                            {(displayPatient.isLocal || patients.find(p => p.cedula === displayPatient.cedula)) ? (
                                <div className="flex items-center gap-2 text-green-700 dark:text-green-400 bg-green-100 dark:bg-gray-800/80 px-3 py-1.5 rounded-full text-xs font-medium border border-green-200 dark:border-gray-700">
                                    <CheckCircle className="h-3.5 w-3.5" />
                                    <span>Registrado</span>
                                </div>
                            ) : (
                                <div className="flex items-center gap-2 text-blue-700 dark:text-blue-400 bg-blue-100 dark:bg-gray-800/80 px-3 py-1.5 rounded-full text-xs font-medium border border-blue-200 dark:border-gray-700">
