...
export function DashboardHeader({
  ...
  const showOfficeSelector = isCitasPage || isPatientsPage || isAgendaPage;
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-full pr-3 flex-1 overflow-x-auto overflow-y-visible gap-x-4 pl-4">
        ...
        {/* Center Section - Office Selector (agenda, citas, pacientes) o Mega Menu */}
        {showOfficeSelector ? (
          <div className="flex-1 flex justify-center min-w-0">
            {loading ? (
              ...
              <Button
                ...
                size="sm"
                className="gap-2"
                onClick={() => router.push("/consultorio/configuracion?tab=consultorios&officeTab=horarios")}
              >
                <Building2 className="h-4 w-4" />
