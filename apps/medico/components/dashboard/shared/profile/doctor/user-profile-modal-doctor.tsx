...
export function UserProfileModalDoctor({
  ...
  const handleVerificationRedirect = () => {
    onClose();
    router.push("/consultorio/perfil/setup");
  };
          ...
          <>
            ...
            {needsVerification ? (
              ...
              <motion.dialog
                ...
                open={isOpen}
                className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl bg-white rounded-xl shadow-2xl z-101 overflow-hidden"
              ...
              >
                <Card className="border-0 shadow-none">
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-4xl" id="verification-modal-title">
