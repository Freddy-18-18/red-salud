      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            ...
            <Link
              href="/consultorio/oftalmologia/examenes"
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            ...
            <Link
              href="/consultorio/oftalmologia/procedimientos"
              className="text-xs text-primary hover:underline"
            >
              Ver todos
            </Link>
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/consultorio/oftalmologia/examenes">
                <Eye className="h-4 w-4" />
                Exámenes Oftalmológicos
              </Link>
            </Button>
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/consultorio/oftalmologia/procedimientos">
                <Activity className="h-4 w-4" />
                Procedimientos
              </Link>
            </Button>
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/consultorio/oftalmologia/analytics">
                <TrendingUp className="h-4 w-4" />
