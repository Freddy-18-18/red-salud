...
export function ProfileSectionV2() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-black dark:via-black dark:to-black">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-800">
              ...
              <div className="space-y-4">
                <FieldWithContext
                  ...
                  locked={profile.is_sacs_user}
                  verified={profile.is_sacs_user}
                  contextInfo={
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-800">
              ...
              <div className="space-y-4">
                ...
                <FieldWithContext
                  ...
                  locked={profile.is_sacs_user && profile.especialidades_adicionales.length > 0}
                  verified={profile.is_sacs_user && profile.especialidades_adicionales.length > 0}
                  contextInfo={
                    profile.is_sacs_user && profile.especialidades_adicionales.length > 0
