            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-2">
                ...
                {validation.suggestions.length > 0 && (
                  <ul className="space-y-1 pt-2 border-t border-gray-200 dark:border-white/10">
                    {validation.suggestions.map((suggestion, index) => (
                      <li key={index} className="text-sm text-gray-600 dark:text-white/60 flex items-start gap-2">
                        <span>💡</span>
