            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-2">
                            <div className="h-7 w-64 bg-gray-200 dark:bg-white/10 rounded-lg animate-pulse" />
                            <div className="h-4 w-48 bg-gray-100 dark:bg-gray-800 rounded animate-pulse" />
                        </div>
                    </div>
                    <div className="h-10 w-40 bg-gray-200 dark:bg-white/10 rounded-lg animate-pulse" />
                </div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                    {[1, 2, 3, 4].map((i) => (
                        <div 
                            key={i}
                            className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-lg"
                        >
                            <div className="flex items-center gap-3 mb-5">
                                <div className="h-11 w-11 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-white/20 dark:to-white/10 rounded-xl animate-pulse" />
            ...
            <div className="flex items-center justify-between mb-10">
                ...
                {!isEditing ? (
                    <Button 
                        ...
                        className="shadow-md hover:shadow-lg transition-all duration-300 border-gray-300 dark:border-white/10 hover:border-blue-500 dark:hover:border-blue-500"
                    >
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                    ...
                    <motion.div
                        ...
                        className="group relative bg-gradient-to-br from-white to-gray-50/50 dark:from-black dark:to-black border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:border-purple-300 dark:hover:border-purple-700"
                    >
                            ...
                            <div className="space-y-5">
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <div className="px-4 py-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-white/10">
                    ...
                    <motion.div
                        ...
                        className="group relative bg-gradient-to-br from-white to-gray-50/50 dark:from-black dark:to-black border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:border-amber-300 dark:hover:border-amber-700"
                    >
                            ...
                            <div className="space-y-5">
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <div className="px-4 py-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-white/10 min-h-[100px]">
                    ...
                    <motion.div
                        ...
                        className="group relative bg-gradient-to-br from-white to-gray-50/50 dark:from-black dark:to-black border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:border-indigo-300 dark:hover:border-indigo-700"
                    >
                                    ...
                                    {IDIOMAS_DISPONIBLES.map((idioma) => (
                                        <button
                                            ...
                                            className={`px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 ${data.idiomas.includes(idioma)
                                                ...
                                                : "bg-gray-100 dark:bg-white/10 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 hover:scale-105"
                                            }`}
                                        >
                                            {idioma}
                                        </button>
                ...
                <div className="space-y-6">
                    ...
                    <motion.div
                        ...
                        className="group relative bg-gradient-to-br from-white to-gray-50/50 dark:from-black dark:to-black border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:border-rose-300 dark:hover:border-rose-700"
                    >
                            ...
                            {isEditing ? (
                                <div className="space-y-4">
                                    <SearchableSelect
                                        ...
                                        className="w-full"
                                    />
                                    <div className="flex flex-wrap gap-2 min-h-[80px] p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-white/10">
                    ...
                    <motion.div
                        ...
                        className="group relative bg-gradient-to-br from-white to-gray-50/50 dark:from-black dark:to-black border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:border-pink-300 dark:hover:border-pink-700"
                    >
