      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            ...
            <Link
              href="/consultorio/traumatologia/lesiones"
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            ...
            <Link
              href="/consultorio/traumatologia/rehabilitacion"
              className="text-xs text-primary hover:underline"
            >
              Ver todas
            </Link>
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/consultorio/traumatologia/lesiones">
                <Bone className="h-4 w-4" />
                Gestión de Lesiones
              </Link>
            </Button>
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/consultorio/traumatologia/rehabilitacion">
                <Dumbbell className="h-4 w-4" />
                Rehabilitación
              </Link>
            </Button>
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/consultorio/traumatologia/analytics">
