...
function getStatusColor(status: string): string {
  ...
  return colors[status] || "bg-yellow-100 text-yellow-800 border-yellow-300";
}
                ...
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <Badge
                        variant="outline"
                        className={`text-xs ${getStatusColor(appointment.status)} ${(appointment.status === "en_espera" || appointment.status === "en_consulta")
                          ? "animate-pulse"
                          : ""
                          }`}
                      >
