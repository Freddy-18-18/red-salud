        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <Button
              ...
              asChild
            >
              <Link href="/consultorio/pediatria/crecimiento">
                <TrendingUp className="h-4 w-4" />
            ...
            <Button
              ...
              asChild
            >
              <Link href="/consultorio/pediatria/vacunacion">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/consultorio/pediatria/neurodesarrollo">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/consultorio/pediatria/adolescentes">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/consultorio/pediatria/portal-padres">
                <Users className="h-4 w-4" />
                Portal de Padres
              </Link>
            </Button>
            <Button
              ...
              asChild
            >
              <Link href="/consultorio/pediatria/telemedicina">
