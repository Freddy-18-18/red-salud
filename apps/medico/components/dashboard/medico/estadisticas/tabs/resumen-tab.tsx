...
function KPICard({ title, value, icon: Icon, trend, trendUp, color }: KPICardProps) {
  ...
  return (
    <Card className="overflow-hidden relative group hover:shadow-md transition-shadow duration-300 border-slate-200 dark:border-white/10 bg-white/50 dark:bg-black/50 backdrop-blur-sm">
      <CardContent className="pt-6">
