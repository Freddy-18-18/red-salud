                  ...
                  {stats.topLocations.map((loc, i) => (
                    <div key={loc.city} className="flex items-center">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="w-full bg-slate-100 dark:bg-black/80 rounded-full h-2">
                          <div
...
function KPICard({ title, value, icon: Icon, subtext, color }: KPICardProps) {
  ...
  return (
    <Card className="bg-white/50 dark:bg-black/50 backdrop-blur-sm hover:shadow-md transition-all">
      <CardContent className="pt-6">
