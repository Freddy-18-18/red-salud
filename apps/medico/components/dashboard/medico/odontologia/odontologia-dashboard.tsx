            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0">
                        ...
                        <Link href="/consultorio/odontologia/rcm" className="text-xs text-primary hover:underline">
                            Abrir módulo
                        </Link>
                    </CardHeader>
                    <CardContent className="grid grid-cols-2 gap-3">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0">
                        ...
                        <Link href="/consultorio/odontologia/growth" className="text-xs text-primary hover:underline">
                            Abrir módulo
                        </Link>
                    </CardHeader>
                    <CardContent className="grid grid-cols-2 gap-3">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0">
                        ...
                        <Link href="/consultorio/odontologia/imaging" className="text-xs text-primary hover:underline">
                            Abrir módulo
                        </Link>
                    </CardHeader>
