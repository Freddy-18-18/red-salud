...
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@red-salud/design-system";
...
export default function HorariosConfigPage() {
  ...
  const loadHorarios = useCallback(async (doctorId: string) => {
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-3 w-40">
                      ...
                      <Label
                        ...
                        className={`text-lg font-semibold cursor-pointer ${horario.activo ? "text-gray-900" : "text-gray-400"
                          }`}
                      >
                        {dia.label}
                      </Label>
