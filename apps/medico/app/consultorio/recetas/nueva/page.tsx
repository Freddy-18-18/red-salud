...
import { Card, CardContent, CardHeader, CardTitle, Button, Label, Input, Textarea } from "@red-salud/design-system";
    ...
    const handleSubmit = useCallback(async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                router.push("/consultorio/recetas");
            } else {
                                ...
                                <div className="space-y-2">
                                    ...
                                    {selectedPatient && (
                                        <p className="text-xs text-muted-foreground pl-1">
                                            <span className="px-1.5 py-0.5 rounded-full bg-muted border text-xs">
