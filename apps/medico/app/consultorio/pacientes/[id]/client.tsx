...
import { Card, CardContent, CardHeader, CardTitle, CardDescription, Button, Tabs, TabsContent, TabsList, TabsTrigger, Badge, Avatar, AvatarFallback, AvatarImage } from "@red-salud/design-system";
import {
  Calendar,
  FileText,
  Pill,
    ...
    <VerificationGuard>
      <div className="container mx-auto px-4 py-8 space-y-6">
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between">
                  ...
                  <Button onClick={() => router.push(`/consultorio/pacientes/${patientId}/editar`)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Button
            variant="outline"
            onClick={() => router.push(`/consultorio/recetas/nueva?paciente=${patientId}`)}
          ...
          <Button
            variant="outline"
            onClick={() => router.push(`/consultorio/notas/nueva?paciente=${patientId}`)}
            className="h-auto py-4"
          >
            <div className="flex flex-col items-center gap-2">
          ...
          <Button
            variant="outline"
            onClick={() => router.push(`/consultorio/citas/nueva?paciente=${patientId}`)}
            className="h-auto py-4"
          >
            <div className="flex flex-col items-center gap-2">
          ...
          <Button
            variant="outline"
            onClick={() => router.push(`/consultorio/mensajeria?paciente=${patientId}`)}
            className="h-auto py-4"
          >
            <div className="flex flex-col items-center gap-2">
                  ...
                  <div className="space-y-4">
                    {prescriptions.map((rx) => (
                      <div
                        ...
                        onClick={() => router.push(`/consultorio/recetas/${rx.id}`)}
                      >
                        <div className="flex items-start justify-between">
                          <div>
