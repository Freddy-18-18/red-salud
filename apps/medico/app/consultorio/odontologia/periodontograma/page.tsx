...
import { Button, Card, CardContent, CardHeader, CardTitle, Alert, AlertDescription, Badge, ScrollArea, Separator, Skeleton } from "@red-salud/design-system";
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/consultorio/odontologia">
