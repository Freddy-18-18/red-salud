...
// Helper constants that remain local to the specialty system logic if needed
// or can be moved to a constants file in @red-salud/types if shared.
 ...
 */
export type SpecialtyRegistry = Map<string, any>; // Will be typed correctly in the registry
