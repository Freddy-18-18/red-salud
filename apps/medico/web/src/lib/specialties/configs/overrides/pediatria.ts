  ...
  modules: {
    clinical: [
      ...
      },
      {
        ...
        icon: 'TrendingUp',
        route: '/dashboard/modulos/pediatrics-growth',
        group: 'clinical',
        order: 3,
        enabledByDefault: true,
        kpiKeys: ['growth_percentile_compliance', 'developmental_milestone_tracking'],
        componentPath: '@/components/modules/pediatrics/growth-curves-module',
      },
      {
        key: 'pediatrics-vaccination',
        label: 'Vacunación',
        icon: 'Syringe',
        route: '/dashboard/modulos/pediatrics-vaccination',
        group: 'clinical',
        order: 4,
        enabledByDefault: true,
        kpiKeys: ['vaccination_coverage', 'up_to_date_rate'],
        componentPath: '@/components/modules/pediatrics/vaccination-module',
      },
      {
