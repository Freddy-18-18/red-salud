...
// =============================================================================
// /auth/forgot-password — Médico.
// Newly added for parity with paciente. Logic mirrors paciente's flow:
// supabase.auth.resetPasswordForEmail → success state → return to login.
// =============================================================================
