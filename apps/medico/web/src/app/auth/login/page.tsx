...
// =============================================================================
// /auth/login — Médico.
// Refactored to consume <AuthShell role="medico">, achieving sibling parity
// with paciente. Bespoke zinc/teal gradient + 2-step Google→Email pattern
// removed in favor of the unified Caribbean-Trust shell.
// =============================================================================
...
export default function LoginPage() {
      ...
      try {
        ...
        if (authError) {
          if (authError.message.includes('Invalid login credentials')) {
            ...
            setError(
              'Tu correo todavía no fue verificado. Revisá tu bandeja de entrada.',
            );
  ...
  return (
    <AuthShell
      role="medico"
      title="Iniciá sesión"
      subtitle="Ingresá a tu consultorio digital"
      footer={
        <>
          ¿No tenés cuenta?{' '}
          <Link
