...
export function SummaryView({ loading, doctorName, isMobile = false }: SummaryViewProps) {
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-baseline gap-2">
                        <span className="text-xs text-muted-foreground truncate">
                            {fecha ? format(new Date(fecha), "d MMM", { locale: es }) : "--"} - {hora || "--:--"}
                        </span>
                    </div>
                </div>
                ...
                {doctorName && (
                    <div className="flex items-start space-x-3 group">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium text-foreground">Dr. {doctorName}</p>
                        </div>
                    </div>
                )}
