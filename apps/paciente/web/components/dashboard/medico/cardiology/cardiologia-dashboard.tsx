      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            ...
            <Link
              href="/dashboard/medico/cardiologia/ecg"
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <Button
              ...
              asChild
            >
              <Link href="/dashboard/medico/cardiologia/paciente-status">
                <TrendingUp className="h-4 w-4" />
            ...
            <Button
              ...
              asChild
            >
              <Link href="/dashboard/medico/cardiologia/pacs">
                <Activity className="h-4 w-4" />
                PACS / Imágenes
              </Link>
            </Button>
            <Button
              ...
              asChild
            >
              <Link href="/dashboard/medico/cardiologia/analytics">
                <TrendingUp className="h-4 w-4" />
                Análisis
              </Link>
            </Button>
            <Button
              ...
              asChild
            >
              <Link href="/dashboard/medico/cardiologia/remisiones">
                <Activity className="h-4 w-4" />
                Remisiones
              </Link>
            </Button>
