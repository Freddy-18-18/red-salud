...
export function TourGuideProvider({ children }: TourGuideProviderProps) {
  ...
  const canAutoStartTours = Boolean(isDashboardRoute && settings.autoStartTours);
  ...
  }, [canAutoStartTours, completedTours, startTour]);
