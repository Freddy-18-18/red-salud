...
import { Avatar, AvatarFallback, AppSwitcher } from "@red-salud/design-system";
...
export function DashboardSidebar({
  ...
  const { activeRole, availableRoles, switchRole } = useSupabaseAuth();
    ...
    <>
      ...
      <div
        className={cn(
          ...
          // Posicionar debajo del header (48px de altura) - igual para medico y paciente
        ...
        >
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  {/* App Switcher - Solo se muestra si hay más de un rol */}
                  {isExpanded && availableRoles.length > 1 && (
                    <div className="px-2 mb-4">
                      <AppSwitcher
                        activeRole={activeRole || "paciente"}
          ...
          <div data-sidebar="footer" className="flex flex-col gap-2 p-2">
            ...
            <button
              ...
              title={!isExpanded ? "Ver configuración" : undefined}
            >
