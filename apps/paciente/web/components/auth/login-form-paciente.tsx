...
export function LoginFormPaciente() {
  ...
  const { checkRateLimit, recordFailedAttempt } = useRateLimit();
              ...
              {step === "choose" ? (
                ...
                >
                  <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary/10 to-transparent border border-white/5 mb-5 group">
                ...
                >
                  <div className="flex items-center gap-4 mb-8">
                    <div className="shrink-0">
                      ...
                      <p className="text-xs text-neutral-500 font-medium">Ingresa tus credenciales</p>
                    </div>
                  </div>
