...
import { Button, Input, Card, CardContent, Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@red-salud/design-system";

// TODO: Import from @red-salud/core once venezuela data and phone utils are extracted
// import { VENEZUELA_ESTADOS } from "@red-salud/core/data/venezuela";
// import { formatVzlaPhone, validateVzlaPhone } from "@red-salud/core/utils/phone";

// Temporary inline placeholder until shared package provides these
const VENEZUELA_ESTADOS: { code: string; name: string; ciudades: string[] }[] = [];

function formatVzlaPhone(value: string): string {
    return value;
}

function validateVzlaPhone(_phone: string): string | null {
    return null;
}
        ...
        try {
            ...
            const { error: ticketError } = await supabase
                ...
                .insert({
                    ...
                    subject: 'empresas',
                    message: `Solicitud de registro de farmacia. RIF: ${formData.rif}. Ubicacion: ${formData.state}, ${formData.city}.`,
                    metadata: {
                        rif: formData.rif,
            ...
            alert('Solicitud enviada con exito. Nuestro equipo se pondra en contacto pronto.');
            ...
            <div className="h-screen w-screen bg-[#F8FAFC] flex flex-col items-center justify-center p-4 overflow-hidden">
                ...
                >
                    ...
                    <p className="text-slate-500 max-w-md mx-auto text-lg">
                        Gracias por unirte a Red Salud. Nuestro equipo revisara tus datos y se pondra en contacto contigo en las proximas 24-48 horas.
                    </p>
                    <div className="pt-8">
        ...
        <div className="h-screen w-screen overflow-hidden bg-[#F8FAFC] flex items-center justify-center p-4 relative">
            ...
            <div className="max-w-2xl w-full">
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500">Complete el formulario para iniciar su proceso de afiliacion</p>
                </div>
                        ...
                        <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); handleSubmit(); }}>
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1.5">
                                        <Label className="text-slate-600 font-medium ml-1">Razon Social</Label>
                                        <Input
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-2 text-blue-600 font-bold text-xs uppercase tracking-widest">
                                        <MapPin className="w-4 h-4" /> Ubicacion
                                    </div>
