...
export default function POSPage() {
  ...
  const quickAccessProducts = [
    ...
    { id: "qa6", name: "Multivitaminico", icon: Heart, color: "bg-pink-500" },
  ...
  const paymentMethods = [
    ...
    { id: "biometric", name: "Biometrico", icon: Fingerprint, color: "bg-purple-600" },
    { id: "mobile", name: "Pago Movil", icon: QrCode, color: "bg-orange-600" },
  ...
  const addToCart = (product: Product, quantity: number = 1) => {
    ...
    if (existingItem) {
      ...
      const itemTotalUSD = product.sale_price_usd * quantity;
      const itemTotalVES = product.sale_price_ves * quantity;
      const itemIvaUSD = itemTotalUSD * product.iva_rate;
      const itemIvaVES = itemTotalVES * product.iva_rate;
  ...
  const updateQuantity = (itemId: string, quantity: number) => {
    ...
    setCart(
      cart.map((item) => {
        if (item.id === itemId) {
          const itemTotalUSD = item.unit_price_usd * quantity;
          const itemTotalVES = item.unit_price_ves * quantity;
          const itemIvaUSD = itemTotalUSD * item.iva_rate;
          const itemIvaVES = itemTotalVES * item.iva_rate;
          ...
          <div className="col-span-8 flex flex-col gap-4">
            <div className="relative">
              <div className="flex items-center gap-2 bg-white rounded-2xl shadow-lg border border-slate-200 px-4 py-3">
                ...
                <input
                  id="product-search"
                  type="text"
                  placeholder="Buscar producto (F1) o escanear codigo de barras..."
                  value={searchQuery}
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
              <h2 className="text-lg font-semibold text-slate-800 mb-4">
                Acceso Rapido - Medicamentos de Venta Libre
              </h2>
            ...
            {showScanner && (
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-slate-800">Escanear Codigo de Barras</h3>
                  <button
                ...
                <div className="bg-slate-100 rounded-xl p-8 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-slate-500">
                      Coloca el codigo de barras frente al escaner
                    </p>
                  </div>
                </div>
              </div>
