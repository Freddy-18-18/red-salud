...
function validateForm(data: LoginFormData): FieldErrors {
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <span className="block text-blue-200 text-sm font-medium">Farmacia</span>
            </div>
          </div>
          <h2 className="text-4xl font-bold leading-tight mb-4">
            Gestion integral para tu farmacia
          </h2>
          <p className="text-lg text-blue-100 leading-relaxed max-w-md">
            Controla inventario, punto de venta, recetas y entregas
            desde una sola plataforma disenada para farmacias venezolanas.
          </p>
          <div className="mt-12 space-y-4">
            <div className="flex items-center gap-3 text-blue-100">
              ...
              <span>Inventario con control de lotes y vencimientos</span>
            </div>
            <div className="flex items-center gap-3 text-blue-100">
              <div className="p-1.5 bg-white/10 rounded-lg">
                <ClipboardList className="w-4 h-4" />
              </div>
              <span>Punto de venta con multiples metodos de pago</span>
            </div>
            <div className="flex items-center gap-3 text-blue-100">
              <div className="p-1.5 bg-white/10 rounded-lg">
                <ShieldCheck className="w-4 h-4" />
              </div>
              <span>Recetas digitales verificadas</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center justify-center gap-2 mb-8">
            ...
            <div>
              ...
              <span className="block text-blue-600 text-xs font-medium -mt-0.5">Farmacia</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 mt-1">
                Ingresa a tu panel de farmacia
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-500">Recordar sesion</span>
                </label>
                <Link
