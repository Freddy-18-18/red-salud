        ...
        <NavigationMenu>
            <NavigationMenuList>
                ...
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        <div className="flex flex-col md:flex-row gap-6 p-6 w-[350px] md:w-[750px] lg:w-[850px] bg-background dark:bg-slate-950 rounded-xl shadow-2xl border border-border/50 dark:border-slate-800">
                            {/* Principal - Pacientes */}
                            <div className="flex-shrink-0 w-full md:w-[240px]">
                                ...
                                <NavigationMenuLink asChild>
                                    <Link
                                        className="group relative flex h-full min-h-[280px] w-full select-none flex-col justify-between overflow-hidden rounded-xl bg-gradient-to-br from-primary via-primary/90 to-secondary dark:from-slate-900 dark:via-slate-800 dark:to-black p-6 no-underline outline-none shadow-lg shadow-primary/20 dark:shadow-black transition-all hover:scale-[1.02] hover:shadow-2xl hover:shadow-primary/30 dark:hover:shadow-black/50 focus:shadow-xl"
                                    ...
                                    >
                                        ...
                                        <div className="absolute -bottom-8 -left-8 h-32 w-32 rounded-full bg-teal-500/20 blur-2xl" />
