...
import { dentalImagingSchema } from "@/lib/specialties/modules/module-schema";
import { dentalImagingService } from "@/lib/supabase/services/odontology-service";
import { useSpecialtyModulePage } from "@/hooks/use-specialty-module-page";

export default function OdontologiaImagenologiaPage() {
  ...
  const {
    ...
    service: dentalImagingService,
    schema: dentalImagingSchema,
    doctorId: user?.id,
  });
