...
import { pediatricsGrowthSchema } from "@/lib/specialties/modules/module-schema";
import { pediatricsGrowthService } from "@/lib/supabase/services/pediatrics-service";
import { useSpecialtyModulePage } from "@/hooks/use-specialty-module-page";

export default function PediatriaCrecimientoPage() {
  ...
  const {
    ...
    service: pediatricsGrowthService,
    schema: pediatricsGrowthSchema,
    doctorId: user?.id,
  });
