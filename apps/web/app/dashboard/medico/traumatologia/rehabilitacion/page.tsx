...
import { traumatologyRehabSchema } from "@/lib/specialties/modules/module-schema";
import { traumatologyRehabService } from "@/lib/supabase/services/traumatology-service";
import { useSpecialtyModulePage } from "@/hooks/use-specialty-module-page";

export default function TraumatologiaRehabilitacionPage() {
  ...
  const {
    ...
    service: traumatologyRehabService,
    schema: traumatologyRehabSchema,
    doctorId: user?.id,
  });
