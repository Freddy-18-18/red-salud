      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            ...
            <Link
              href="/dashboard/medico/ginecologia/obstetricia"
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            ...
            <Link
              href="/dashboard/medico/ginecologia/controles"
              className="text-xs text-primary hover:underline"
            >
              Ver todos
            </Link>
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/dashboard/medico/ginecologia/controles">
                <ClipboardList className="h-4 w-4" />
                Controles Ginecológicos
              </Link>
            </Button>
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/dashboard/medico/ginecologia/obstetricia">
                <Baby className="h-4 w-4" />
                Obstetricia
              </Link>
            </Button>
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/dashboard/medico/ginecologia/analytics">
