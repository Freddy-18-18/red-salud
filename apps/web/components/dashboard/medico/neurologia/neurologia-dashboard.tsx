      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            ...
            <Link
              href="/dashboard/medico/neurologia/estudios"
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            ...
            <Link
              href="/dashboard/medico/neurologia/evaluaciones"
              className="text-xs text-primary hover:underline"
            >
              Ver todas
            </Link>
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <Button
              ...
              asChild
            >
              <Link href="/dashboard/medico/neurologia/estudios">
                <Activity className="h-4 w-4" />
            ...
            <Button
              ...
              asChild
            >
              <Link href="/dashboard/medico/neurologia/evaluaciones">
                <ClipboardList className="h-4 w-4" />
            ...
            <Button
              ...
              asChild
            >
              <Link href="/dashboard/medico/neurologia/analytics">
                <TrendingUp className="h-4 w-4" />
                Análisis y Reportes
              </Link>
            </Button>
