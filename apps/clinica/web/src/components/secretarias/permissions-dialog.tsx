...
import { Switch } from "@red-salud/design-system";
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-lg">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Define que puede hacer {secretary?.secretary_name}
                    </DialogDescription>
                </DialogHeader>
                {secretary && (
                    <div className="space-y-4 py-4">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <Label>Ver Historial Clinico</Label>
                                <p className="text-xs text-gray-500 text-red-600">Acceso a informacion medica sensible</p>
                            </div>
                            <Switch
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <Label>Ver Estadisticas</Label>
                                <p className="text-xs text-gray-500 text-red-600">Incluye informacion financiera</p>
                            </div>
                            <Switch
