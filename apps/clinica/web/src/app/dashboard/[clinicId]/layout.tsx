/**
 * Layout principal del dashboard de clinica
 */
...
import { ClinicScopeProvider, useClinicScope } from '@/components/clinica/clinic-scope-provider';
    ...
    return (
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-2">Clinica no encontrada</h2>
          <p className="text-muted-foreground">
            No tienes acceso a esta clinica o no existe.
          </p>
        </div>
      </div>
    );
