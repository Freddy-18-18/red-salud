/**
 * Servicio principal para gestion de clinicas y sedes
 *
...
/**
 * Obtiene todas las clinicas donde el usuario tiene rol activo
 */
...
/**
 * Obtiene una clinica especifica por ID
 */
...
export async function createClinic(input: CreateClinicInput): Promise<Clinic> {
  ...
  // Asignar automaticamente rol de owner al creador
...
/**
 * Actualiza una clinica existente
 */
...
/**
 * Obtiene todas las sedes de una clinica
 */
...
/**
 * Crea una nueva sede para una clinica
 */
...
/**
 * Obtiene los roles de un usuario en todas las clinicas
 */
...
/**
 * Obtiene los roles de una clinica especifica
 */
...
/**
 * Asigna un rol a un usuario en una clinica
 */
...
/**
 * Obtiene estadisticas generales de una clinica (overview)
 */
...
/**
 * Verifica si el usuario tiene un rol especifico en una clinica
 */
